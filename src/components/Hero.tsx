      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 text-left">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full text-xs font-bold tracking-wider uppercase">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.1]">
              SHARMA <br />
              <span className="bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-300 bg-clip-text text-transparent animate-pulse">
                PROP MART
              </span>
            </h1>

            <p className="text-emerald-500 font-bold text-lg sm:text-xl uppercase tracking-widest block font-sans">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                href={`https://wa.me/${OFFICE_CONTACT.rawPhone2}?text=Hello%20I%20want%20to%20inquire%20about%20Authority%20Plots`}
                target="_blank"
                referrerPolicy="no-referrer"
                className="flex items-center justify-center gap-3 bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-extrabold text-lg transition-all shadow-xl shadow-emerald-950/40 hover:shadow-emerald-600/20 text-center active:scale-95 duration-100 cursor-pointer"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 px-6 py-4 rounded-xl font-bold text-base transition-all hover:border-slate-600 cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 bg-gradient-to-b from-slate-900 to-slate-950/95 border border-slate-800 p-6 sm:p-8 rounded-2xl shadow-2xl relative">
            <div className="absolute top-0 right-6 -translate-y-1/2 bg-emerald-500 text-slate-950 text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full shadow-lg">
              Live Search Portal
            </div>
            ...
            <form onSubmit={handleSearchSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-2 bg-slate-850 p-1.5 rounded-lg border border-slate-850">
                  {(['Buy', 'Sell', 'Rent'] as const).map((t) => (
                    <button
                      ...
                      className={`py-2 px-3 rounded-md text-xs font-bold tracking-wide transition-all cursor-pointer ${
                        searchIntent === t
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 bg-slate-850 p-1.5 rounded-lg border border-slate-850">
                  <button
                    ...
                    className={`py-2 px-3 rounded-md text-xs font-bold transition-all truncate cursor-pointer ${
                      regionIntent === 'yamuna'
                        ? 'bg-emerald-500 text-slate-950 shadow'
                        : 'text-slate-400 hover:text-white'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-850 border border-slate-800 text-white rounded-lg pl-10 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-slate-200 placeholder-slate-500 font-medium"
                  />
              ...
              <button
                type="submit"
                className="w-full bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-extrabold text-sm py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/10 cursor-pointer"
              >
